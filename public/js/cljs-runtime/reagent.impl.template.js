...
var G__16647 = o;
reagent.impl.template.goog$module$goog$object.set(G__16647,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__16665__delegate = function (args){
...
while (G__16666__i < G__16666__a.length) {G__16666__a[G__16666__i] = arguments[G__16666__i + 0]; ++G__16666__i;}
  args = new cljs.core.IndexedSeq(G__16666__a,0,null);
} 
return G__16665__delegate.call(this,args);};
...
return G__16665__delegate(args);
});
...
var G__16648 = o;
reagent.impl.template.goog$module$goog$object.set(G__16648,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__16669__i < G__16669__a.length) {G__16669__a[G__16669__i] = arguments[G__16669__i + 0]; ++G__16669__i;}
  args = new cljs.core.IndexedSeq(G__16669__a,0,null);
} 
...
var args = cljs.core.seq(arglist__16670);
...
var G__16649 = props;
var G__16649__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__16649,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__16649);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__16649__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__16650 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__16650,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__16650;
}
})(),id_class);
...
var G__16651 = (cljs.core.count(argv) - first_child);
switch (G__16651) {
case (0):
...
var vec__16652 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16652,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16652,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16652,(2),null);
...
var temp__5808__auto___16678 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___16678 == null)){
} else {
var key_16679 = temp__5808__auto___16678;
(jsprops.key = key_16679);
}
...
var temp__5808__auto___16680 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___16680 == null)){
} else {
var key_16681 = temp__5808__auto___16680;
(jsprops.key = key_16681);
}
...
var temp__5808__auto___16686 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___16686 == null)){
} else {
var key_16687 = temp__5808__auto___16686;
(jsprops.key = key_16687);
}
...
var temp__5808__auto___16696 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___16696 == null)){
} else {
var key_16697 = temp__5808__auto___16696;
(jsprops.key = key_16697);
}
...
var temp__5808__auto___16700 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___16700 == null)){
} else {
var key_16701 = temp__5808__auto___16700;
(jsprops.key = key_16701);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__16655_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__16655_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__16656 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16656,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16656,(1),null);
...
break;
default:
var G__16709 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__16710 = compiler;
v = G__16709;
compiler = G__16710;
continue;
...
var G__16660 = tag;
var G__16660__$1 = (((G__16660 instanceof cljs.core.Keyword))?G__16660.fqn:null);
switch (G__16660__$1) {
case ">":
...
*/
reagent.impl.template.t_reagent$impl$template16662 = (function (opts,id,fn_to_element,parse_fn,meta16663){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template16662.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_16664,meta16663__$1){
var self__ = this;
var _16664__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template16662(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta16663__$1));
}));

(reagent.impl.template.t_reagent$impl$template16662.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_16664){
var self__ = this;
var _16664__$1 = this;
return self__.meta16663;
}));

(reagent.impl.template.t_reagent$impl$template16662.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template16662.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template16662.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template16662.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template16662.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template16662.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta16663","meta16663",1771883525,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template16662.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template16662.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template16662");

(reagent.impl.template.t_reagent$impl$template16662.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"reagent.impl.template/t_reagent$impl$template16662");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template16662.
 */
reagent.impl.template.__GT_t_reagent$impl$template16662 = (function reagent$impl$template$__GT_t_reagent$impl$template16662(opts,id,fn_to_element,parse_fn,meta16663){
return (new reagent.impl.template.t_reagent$impl$template16662(opts,id,fn_to_element,parse_fn,meta16663));
});
...
return (new reagent.impl.template.t_reagent$impl$template16662(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
