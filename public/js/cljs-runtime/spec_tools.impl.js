...
var vec__18110 = cljs.core.rest(expr);
...
var vec__18113 = first__18112;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18113,(0),null);
var form = seq__18111__$1;
...
var G__18116 = x;
var G__18116__$1 = (((G__18116 == null))?null:spec_tools.impl.polish(G__18116));
var G__18116__$2 = (((G__18116__$1 == null))?null:cljs.core.name(G__18116__$1));
if((G__18116__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__18116__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__18117 = x;
var G__18117__$1 = (((G__18117 == null))?null:cljs.core.name(G__18117));
if((G__18117__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__18117__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__18122){
var map__18124 = p__18122;
var map__18124__$1 = cljs.core.__destructure_map(map__18124);
var data = map__18124__$1;
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18124__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18124__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18124__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18124__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__18128){
var map__18129 = p__18128;
var map__18129__$1 = cljs.core.__destructure_map(map__18129);
var data = map__18129__$1;
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18129__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18129__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var G__18130 = data;
var G__18130__$1 = (cljs.core.truth_(req_un)?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__18130,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key)):G__18130);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__18130__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__18130__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__18134 = form;
var G__18134__$1 = (((G__18134 == null))?null:cljs.core.rest(G__18134));
if((G__18134__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__18134__$1);
}
})();
var G__18135 = m;
var G__18135__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__18135,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__18131_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__18131_SHARP_)));
})):G__18135);
var G__18135__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__18135__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__18132_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__18132_SHARP_)));
})):G__18135__$1);
var G__18135__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__18135__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__18133_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,p1__18133_SHARP_));
})):G__18135__$2);
return spec_tools.impl.with_real_keys(spec_tools.impl.with_key__GT_spec(G__18135__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__18136 = (function (){var G__18137 = form;
var G__18137__$1 = (((G__18137 == null))?null:cljs.core.rest(G__18137));
if((G__18137__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__18137__$1);
}
})();
var map__18136__$1 = cljs.core.__destructure_map(map__18136);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18136__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18136__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18136__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18136__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var G__18140 = (function (){var and__5043__auto__ = (kw instanceof cljs.core.Symbol);
...
return cljs.core.boolean$(((cljs.core.seq_QMARK_(form))?(function (){var G__18145 = form;
var G__18145__$1 = (((G__18145 == null))?null:cljs.core.seq(G__18145));
var G__18145__$2 = (((G__18145__$1 == null))?null:cljs.core.first(G__18145__$1));
if((G__18145__$2 == null)){
return null;
} else {
var fexpr__18146 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null);
return (fexpr__18146.cljs$core$IFn$_invoke$arity$1 ? fexpr__18146.cljs$core$IFn$_invoke$arity$1(G__18145__$2) : fexpr__18146.call(null,G__18145__$2));
}
})():null));
});
/**
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq18147){
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__18150){
var vec__18151 = p__18150;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18151,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18151,(1),null);
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__18156){
var map__18157 = p__18156;
var map__18157__$1 = cljs.core.__destructure_map(map__18157);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18157__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18157__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18157__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18157__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var pred_exprs = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__18154_SHARP_){
return cljs.core.map_QMARK_(p1__18154_SHARP_);
})], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return (function (p1__18155_SHARP_){
return cljs.core.contains_QMARK_(p1__18155_SHARP_,x);
});
}),req_keys));
