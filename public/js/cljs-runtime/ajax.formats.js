...
var G__17146 = request;
var G__17147 = cljs.core.second(format_entry);
return (ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2 ? ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2(G__17146,G__17147) : ajax.formats.get_format.call(null,G__17146,G__17147));
} else {
...
return cljs.core.some((function (p1__17155_SHARP_){
return ajax.formats.content_type_matches(content_type,p1__17155_SHARP_);
}),accept);
});
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__17156){
var map__17157 = p__17156;
var map__17157__$1 = cljs.core.__destructure_map(map__17157);
var request = map__17157__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17157__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__17164 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__17164.cljs$core$IFn$_invoke$arity$1 ? fexpr__17164.cljs$core$IFn$_invoke$arity$1(response) : fexpr__17164.call(null,response));
});
});
ajax.formats.accept_header = (function ajax$formats$accept_header(p__17167){
var map__17168 = p__17167;
var map__17168__$1 = cljs.core.__destructure_map(map__17168);
var request = map__17168__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17168__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
return ajax.formats.get_accept_entries(request,p1__17166_SHARP_);
