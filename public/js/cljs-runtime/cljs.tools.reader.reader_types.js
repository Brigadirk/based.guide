...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_14795 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_14795(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_14796 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_14796(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_14797 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_14797(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_14798 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_14798(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_14799 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_14799(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_14801 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_14801(reader);
}
});
...
var G__14815 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__14816 = s.append(c);
c = G__14815;
s = G__14816;
continue;
}
