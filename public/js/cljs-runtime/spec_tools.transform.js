...
if((x instanceof cljs.core.Keyword)){
var G__18322 = spec;
var G__18323 = spec_tools.transform.keyword__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__18322,G__18323) : f.call(null,G__18322,G__18323));
} else {
if(typeof x === 'string'){
...
if((x instanceof cljs.core.Keyword)){
var G__18337 = spec;
var G__18338 = spec_tools.transform.keyword__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__18337,G__18338) : f.call(null,G__18337,G__18338));
} else {
return x;
...
if(typeof x === 'number'){
var G__18339 = spec;
var G__18340 = spec_tools.transform.number__GT_string(spec,x);
...
}catch (e18343){if((e18343 instanceof Error)){
var ___$1 = e18343;
return x;
} else {
throw e18343;
...
}catch (e18344){if((e18344 instanceof Error)){
var ___$1 = e18344;
return x;
} else {
throw e18344;
...
}catch (e18372){if((e18372 instanceof Error)){
var ___$1 = e18372;
return x;
} else {
throw e18372;
...
spec_tools.transform.strip_extra_keys = (function spec_tools$transform$strip_extra_keys(p__18385,x){
var map__18386 = p__18385;
var map__18386__$1 = cljs.core.__destructure_map(map__18386);
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18386__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.fail_on_extra_keys = (function spec_tools$transform$fail_on_extra_keys(p__18387,x){
var map__18388 = p__18387;
var map__18388__$1 = cljs.core.__destructure_map(map__18388);
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18388__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.strip_extra_values = (function spec_tools$transform$strip_extra_values(p__18389,x){
var map__18390 = p__18389;
var map__18390__$1 = cljs.core.__destructure_map(map__18390);
var items = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18390__$1,new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600));
