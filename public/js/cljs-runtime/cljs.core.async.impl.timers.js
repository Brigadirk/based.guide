...
var i_13476 = (0);
while(true){
if((i_13476 < arr.length)){
(arr[i_13476] = null);

var G__13479 = (i_13476 + (1));
i_13476 = G__13479;
continue;
} else {
}
...
var i_13495 = (self__.level + (1));
while(true){
if((i_13495 <= (new_level + (1)))){
(update[i_13495] = self__.header);

var G__13497 = (i_13495 + (1));
i_13495 = G__13497;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_13501 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_13501[i]));
} else {
x__$2.forward.push((((i < links_13501.length))?(links_13501[i]):null));
}

if((i < links_13501.length)){
(links_13501[i] = x__$2);
} else {
links_13501.push(x__$2);
}
...
var i_13507 = (0);
while(true){
if((i_13507 <= self__.level)){
var links_13508 = (update[i_13507]).forward;
if((x__$1 === (((i_13507 < links_13508.length))?(links_13508[i_13507]):null))){
(links_13508[i_13507] = (x__$1.forward[i_13507]));

var G__13511 = (i_13507 + (1));
i_13507 = G__13511;
continue;
} else {
var G__13512 = (i_13507 + (1));
i_13507 = G__13512;
continue;
}
} else {
