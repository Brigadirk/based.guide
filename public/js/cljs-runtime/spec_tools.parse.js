...
var fexpr__18161 = ((cljs.core.sequential_QMARK_(type))?cljs.core.first:cljs.core.identity);
return (fexpr__18161.cljs$core$IFn$_invoke$arity$1 ? fexpr__18161.cljs$core$IFn$_invoke$arity$1(type) : fexpr__18161.call(null,type));
});
...
var G__18168 = spec_tools.impl.normalize_symbol(x);
var G__18169 = null;
var G__18170 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__18168,G__18169,G__18170) : spec_tools.parse.parse_form.call(null,G__18168,G__18169,G__18170));
} else {
if(cljs.core.seq_QMARK_(x)){
var G__18171 = spec_tools.impl.normalize_symbol(cljs.core.first(x));
var G__18172 = x;
var G__18173 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__18171,G__18172,G__18173) : spec_tools.parse.parse_form.call(null,G__18171,G__18172,G__18173));
} else {
if(cljs.core.truth_(cljs.spec.alpha.spec_QMARK_(x))){
var G__18308 = cljs.spec.alpha.form(x);
var G__18309 = options;
x = G__18308;
options = G__18309;
continue;
} else {
if(cljs.core.ifn_QMARK_(x)){
var G__18174 = spec_tools.impl.normalize_symbol(spec_tools.form.resolve_form.cljs$core$IFn$_invoke$arity$1(x));
var G__18175 = null;
var G__18176 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__18174,G__18175,G__18176) : spec_tools.parse.parse_form.call(null,G__18174,G__18175,G__18176));
} else {
...
var G__18177 = parse_data;
var G__18177__$1 = (((G__18177 == null))?null:new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600).cljs$core$IFn$_invoke$arity$1(G__18177));
var G__18177__$2 = (((G__18177__$1 == null))?null:cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.parse.get_keys,G__18177__$1));
var G__18177__$3 = (((G__18177__$2 == null))?null:cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,G__18177__$2));
var G__18177__$4 = (((G__18177__$3 == null))?null:cljs.core.seq(G__18177__$3));
if((G__18177__$4 == null)){
return null;
} else {
return cljs.core.set(G__18177__$4);
}
}
});
...
var hierarchy__5646__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("spec-tools.parse","default","spec-tools.parse/default",-1184283850)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__18178 = cljs.core.get_global_hierarchy;
return (fexpr__18178.cljs$core$IFn$_invoke$arity$0 ? fexpr__18178.cljs$core$IFn$_invoke$arity$0() : fexpr__18178.call(null));
})());
...
var map__18205 = spec_tools.impl.parse_keys(form);
var map__18205__$1 = cljs.core.__destructure_map(map__18205);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18205__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18205__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18205__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18205__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var key__GT_spec = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18205__$1,new cljs.core.Keyword(null,"key->spec","key->spec",1088543019));
var G__18211 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.Keyword("spec-tools.parse","key->spec","spec-tools.parse/key->spec",1347735257),key__GT_spec,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(req,opt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([req_un,opt_un], 0)))], null);
var G__18211__$1 = (cljs.core.truth_((function (){var or__5045__auto__ = req;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
return req_un;
}
})())?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__18211,new cljs.core.Keyword("spec-tools.parse","keys-req","spec-tools.parse/keys-req",-1559250753),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(req,req_un))):G__18211);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__18211__$1,new cljs.core.Keyword("spec-tools.parse","keys-opt","spec-tools.parse/keys-opt",-1090203455),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(opt,opt_un)));
} else {
return G__18211__$1;
}
}));
...
var vec__18212 = multi_spec_form;
...
var _ = first__18214;
var first__18214__$1 = cljs.core.first(seq__18213__$1);
var seq__18213__$2 = cljs.core.next(seq__18213__$1);
var multi_method_symbol = first__18214__$1;
var ___$1 = seq__18213__$2;
var form = vec__18212;
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__18215){
var vec__18216 = p__18215;
var spec_k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18216,(0),null);
var method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18216,(1),null);
...
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2(cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__18227_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__18227_SHARP_,options);
...
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__18240_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__18240_SHARP_,options);
}),cljs.core.rest(form));
...
var type_priority = (function (p1__18259_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__18259_SHARP_),new cljs.core.Keyword(null,"multi-spec","multi-spec",1274719724))){
return (1);
} else {
return (0);
}
});
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.deep_merge,cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(type_priority,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__18260_SHARP_){
return spec_tools.parse.parse_spec.cljs$core$IFn$_invoke$arity$2(p1__18260_SHARP_,options);
}),cljs.core.rest(form))));
}));
...
var map__18261 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
var map__18261__$1 = cljs.core.__destructure_map(map__18261);
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18261__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
var map__18262 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
var map__18262__$1 = cljs.core.__destructure_map(map__18262);
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18262__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","map-of","clojure.spec.alpha/map-of",2125010727,null),(function (_,p__18263,options){
var vec__18264 = p__18263;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18264,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18264,(1),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18264,(2),null);
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","tuple","clojure.spec.alpha/tuple",800350846,null),(function (_,p__18268,options){
...
var ___$1 = first__18271;
var values = seq__18270__$1;
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__18267_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__18267_SHARP_,options);
}),values);
...
var type_priority = (function (p1__18284_SHARP_){
var G__18287 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"map","map",1371690461),(1),new cljs.core.Keyword(null,"multi-spec","multi-spec",1274719724),(0)], null);
var fexpr__18286 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__18284_SHARP_);
...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.deep_merge,cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(type_priority,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__18285_SHARP_){
return spec_tools.parse.parse_spec.cljs$core$IFn$_invoke$arity$2(p1__18285_SHARP_,options);
}),cljs.core.rest(form))));
}));
