 ...
 * @define {string}
 */
app.api.backend.env = goog.define("app.api.backend.env","prod");
app.api.backend.api_url = (function app$api$backend$api_url(){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(app.api.backend.env,"dev")){
return "http://localhost:8080";
} else {
return "https://based-guide-backend.onrender.com";
}
});
...
console.log("env",app.api.backend.env);

console.log("Linky: ",[app.api.backend.api_url(),"/front"].join(''));

return ajax.core.GET.cljs$core$IFn$_invoke$arity$variadic([app.api.backend.api_url(),"/front"].join(''),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"handler","handler",-195596612),(function (response){
...
return ajax.core.GET.cljs$core$IFn$_invoke$arity$variadic([app.api.backend.api_url(),"/projects/",cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"pageid","pageid",160137765).cljs$core$IFn$_invoke$arity$1(page))].join(''),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"handler","handler",-195596612),(function (response){
