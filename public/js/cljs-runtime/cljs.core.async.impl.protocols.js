...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_11266 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_11266(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_11269 = (function (port,val,fn1_handler){
var x__5393__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_11269(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_11273 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_11273(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_11274 = (function (chan){
var x__5393__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_11274(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$commit$dyn_11281 = (function (h){
var x__5393__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_11281(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_11288 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_11288(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_11289 = (function (b){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_11289(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_11294 = (function (b,itm){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_11294(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_11299 = (function (b){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_11299(b);
}
});
