...
spec_tools.swagger.core.accept_spec.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),(function (_,___$1,children,p__19625){
var map__19626 = p__19625;
var map__19626__$1 = cljs.core.__destructure_map(map__19626);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19626__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var in$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19626__$1,new cljs.core.Keyword(null,"in","in",-1531184865));
...
var vec__19632 = spec_tools.impl.extract_form(spec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19632,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19632,(1),null);
...
var method_cache__5644__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__5645__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__5646__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__19648 = cljs.core.get_global_hierarchy;
return (fexpr__19648.cljs$core$IFn$_invoke$arity$0 ? fexpr__19648.cljs$core$IFn$_invoke$arity$0() : fexpr__19648.call(null));
})());
...
var map__19650 = spec_tools.swagger.core.transform.cljs$core$IFn$_invoke$arity$2(spec,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"in","in",-1531184865),in$,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"parameter","parameter",1978789597)], null));
var map__19650__$1 = cljs.core.__destructure_map(map__19650);
var properties = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19650__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
var required = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19650__$1,new cljs.core.Keyword(null,"required","required",1807647006));
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p__19652){
var vec__19654 = p__19652;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19654,(0),null);
var map__19657 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19654,(1),null);
var map__19657__$1 = cljs.core.__destructure_map(map__19657);
var schema = map__19657__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19657__$1,new cljs.core.Keyword(null,"type","type",1174270348));
...
var method_cache__5644__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__5645__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__5646__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__19665 = cljs.core.get_global_hierarchy;
return (fexpr__19665.cljs$core$IFn$_invoke$arity$0 ? fexpr__19665.cljs$core$IFn$_invoke$arity$0() : fexpr__19665.call(null));
})());
...
})(),(function (){var iter__5523__auto__ = (function spec_tools$swagger$core$iter__19670(s__19671){
return (new cljs.core.LazySeq(null,(function (){
var s__19671__$1 = s__19671;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__19671__$1);
if(temp__5804__auto__){
var s__19671__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__19671__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__19671__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__19673 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__19672 = (0);
while(true){
if((i__19672 < size__5522__auto__)){
var vec__19678 = cljs.core._nth(c__5521__auto__,i__19672);
var status = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19678,(0),null);
var response = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19678,(1),null);
cljs.core.chunk_append(b__19673,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [status,(function (){var $ = response;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__19673),spec_tools$swagger$core$iter__19670(cljs.core.chunk_rest(s__19671__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__19673),null);
}
} else {
var vec__19682 = cljs.core.first(s__19671__$2);
var status = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19682,(0),null);
var response = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19682,(1),null);
...
var $__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"schema","schema",-1582001791).cljs$core$IFn$_invoke$arity$1($))?cljs.core.update.cljs$core$IFn$_invoke$arity$4($,new cljs.core.Keyword(null,"schema","schema",-1582001791),spec_tools.swagger.core.transform,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"schema","schema",-1582001791)], null)):$);
return cljs.core.update.cljs$core$IFn$_invoke$arity$3($__$1,new cljs.core.Keyword(null,"description","description",-1428560544),cljs.core.fnil.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,""));
})()], null),spec_tools$swagger$core$iter__19670(cljs.core.rest(s__19671__$2)));
}
} else {
return null;
}
...
var new$ = cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__19689){
var vec__19693 = p__19689;
var in$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19693,(0),null);
var spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19693,(1),null);
return spec_tools.swagger.core.extract_parameter.cljs$core$IFn$_invoke$arity$2(in$,spec);
}),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([v], 0));
var merged = cljs.core.vec(cljs.core.reverse(cljs.core.first(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p__19696,p){
var vec__19698 = p__19696;
var ps = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19698,(0),null);
var cache = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19698,(1),null);
var acc__$1 = vec__19698;
